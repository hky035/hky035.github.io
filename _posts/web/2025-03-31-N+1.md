...
<div style="display: flex; justify-content: center;">
    <div style="display: inline-block;">
        <table>
            <thead>
            <tr>
                <th style="width: calc(100/3)%; min-width: 100px;">team_id</th>
                <th style="width: calc(100/3)%; min-width: 100px;">member_id</th>
                <th style="width: calc(100/3)%; min-width: 100px;">teacher_id</th>
            </tr>
            </thead>
            <tr>
