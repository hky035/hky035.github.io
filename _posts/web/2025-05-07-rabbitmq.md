...
![exchange](/assets/img/docs/web/rabbitmq/exchange.png)
...
<table>
  <thead>
  <tr>
    <th class="td-divider">동일 서버 내 Producer-Consumer 배치</th>
    <th>별도 서버에 Producer-Consumer 분리</th>
  </tr>
  </thead>
  <tr>
    <td style="width: 50%;" class="td-divider">
  ...
  <tr>
    <td style="width: 50%; text-align: center;" class="td-divider">
      33.3%
    </td>
